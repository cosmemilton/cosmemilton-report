...
import type { TsvOptions } from "./serializers/tsv.js";
...
export function exportReportToTsv<T>(input: ReportRenderInput<T>, options?: TsvOptions): string {
  return datasetToTsv(buildDatasetFromInput(input), options);
}
